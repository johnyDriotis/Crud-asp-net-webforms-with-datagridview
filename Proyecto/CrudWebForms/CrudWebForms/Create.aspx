<%@ Page Title="Crear usuario" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="CrudWebForms._Create" %>
    ...
    <div class="col-sm-9 col-md-9" style="top: 100px">
        <div class="well">
            <div class="form-horizontal">
                <fieldset>
                    <legend class="text-center">Agregar un nuevo usuario</legend>
                    ...
                    <div class="form-group">
                        <div class="btn-group col-lg-12 col-lg-offset-2">
                            ...
                            <asp:Button ID="btnAceptar" runat="server" Text="Agregar" CssClass="btn btn-primary center-block " OnClick="btnAceptar_Click" />
